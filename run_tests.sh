...
./build_version.sh 3 12 6 python-3.12-embed "LD_LIBRARY_PATH=/usr/local/lib /usr/local/bin/python3.1? -m tests"
./build_version.sh 3 13 0rc2 python-3.13-embed "LD_LIBRARY_PATH=/usr/local/lib /usr/local/bin/python3.1? -m tests"
